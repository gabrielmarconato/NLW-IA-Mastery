    ...
    <div className='min-h-screen flex flex-col'>
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-5">
          <span className="text-sm text-muted-foreground">Desenvolvido com ♥️ no NLW IA</span>
      ...
      <main className='flex flex-1 p-6 gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: Você pode utilizar a variável <code className='text-violet-400'>{'{transcription}'}</code> no seu prompt para adicionar conteúdo da transcrição do vídeo selecionado
          </p>
        </div>
